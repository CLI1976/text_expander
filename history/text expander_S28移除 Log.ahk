...
EditSnippet(*) {
    ...
    ManageLogFile(A_ScriptDir "\edit_log.txt", "顯示關鍵字: " displayKeyword)
    ManageLogFile(A_ScriptDir "\edit_log.txt", "實際關鍵字: " oldKeyword)
    ManageLogFile(A_ScriptDir "\edit_log.txt", "短語: " oldPhrase)
    ManageLogFile(A_ScriptDir "\edit_log.txt", "是否為memo: " isMemo)
    ...
    SaveEditHandler(*) {
        ...
        if (keyword != "" && phrase != "") {
            ...
            FileAppend("ListView 已更新 (顯示: " displayKeywordForLV ")`n", A_ScriptDir "\edit_log.txt")
